...
function getMotivation(prizeWinner){
    for (var i = 0; i < firstNames.length; i++){
        if (lastNames[i].toLowerCase().includes(prizeWinner.toLowerCase()) || firstNames[i].toLowerCase().includes(prizeWinner.toLowerCase()) || (firstNames[i].toLowerCase()+" "+lastNames[i].toLowerCase()).includes(prizeWinner.toLowerCase())){
...
console.log(getLastName("vernon l."))
